          ...
          <div class="row">
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                  ...
                  <div class="col-sm-9">
                    <select name="class_id" class="col-xs-10 col-sm-5">
                      ...
                      <?php if(is_array($class) || $class instanceof \think\Collection || $class instanceof \think\Paginator): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $vo['id']; ?>" <?php if($goods['cid'] === $vo['id']): ?>selected='selected'<?php endif; ?>>&nbsp;&nbsp;<?php echo $vo['name']; ?></option>
                      <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 保质期 </label>
                  <div class="col-sm-9">
                    <input name="period" type="text" class="col-xs-10 col-sm-5" placeholder="请填写保质期" value="<?php echo $goods['period']; ?>" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                	...
                	<div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
	                  <input <?php if($goods['picture']): ?>name='picture'<?php endif; ?> type="text" class="form-control" readonly placeholder="请上传这里商品轮播" value="<?php echo $goods['picture']; ?>" /><br />
	                </div>
                	<div class="col-sm-2 col-lg-2" style="padding-left: 0px;">
                		<a href="javascript:void(0);" class="btn btn-sm btn-success" id="picture_upload" data-type="headimg">上传商品轮播图</a>
                	</div>
                </div>
                <div class="form-group">
                	...
                	<div class="col-sm-3 col-lg-3" style="padding-right: 0px;width:31%">
										<blockquote class="layui-elem-quote layui-quote-nm" style='margin-top:-20px;'>
											预览图：<div class="layui-upload-list" id="picture_view">
												<?php if($goods['pictures']): if(is_array($goods['pictures']) || $goods['pictures'] instanceof \think\Collection || $goods['pictures'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods['pictures'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
														<img style="margin-right:4%;width:20%;height:100px;" src="<?php echo $vo; ?>" />
                ...
                <div class="clearfix form-actions">
                  <div class="col-md-offset-3 col-md-9">
                  	<input name='area_type' type='hidden' value='<?php echo $area_id; ?>'/>
...
var shop_id = $('#shop_id').val();
    ...
    ,multiple: true
    ,done: function(res){
      $('#picture_view').append('<img style="margin-right:4%;width:20%;height:100px;" src="'+ res.url +'" /><input type="hidden" name="picture[]" value="'+ res.url +'">');
    }
});
});
</script>
