...
<div class="vip_nav">
    <ul>
        ...
        <div class="main_right">
            ...
            <div class="bonus_box">
                <div class="bonus_main">
                    <?php if(is_array($bonus['thaw_bouns']) || $bonus['thaw_bouns'] instanceof \think\Collection || $bonus['thaw_bouns'] instanceof \think\Paginator): $i = 0; $__LIST__ = $bonus['thaw_bouns'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	                    <div>
