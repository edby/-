    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo url('Index/goods_order'); ?>"><?php echo config('WEB_SITE_NAME'); ?></a> </li>
                    <li> <a href="<?php echo url('goods_order'); ?>">订单记录管理</a> </li>
...
<script type="text/javascript">
    $('a[href="/Admin/Method/goods_order"]').parents().filter('li').addClass('open active');
